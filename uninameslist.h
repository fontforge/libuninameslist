...
#define UNICODE_BLOCK_MAX	305
#define UNICODE_EN_BLOCK_MAX	305
extern const struct unicode_block UnicodeBlock[305];
...
/* Return number of blocks in this NamesList (Version 10.9). */
