...
#define UNICODE_BLOCK_MAX	367
#define UNICODE_EN_BLOCK_MAX	367
extern const struct unicode_block UnicodeBlock[367];
...
/* Return number of blocks in this NamesList (Version 18.0). */
